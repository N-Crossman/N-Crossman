...
I'm a passionate full stack developer studying at the **University of Alberta**, where I'm honing my skills in modern web technologies and software engineering principles. I love transforming ideas into elegant, functional code and building solutions that make a difference.
...
const noah = {
  ...
  education: "Full Stack Web Development @ University of Alberta",
  interests: ["Web Development", "Sports & Fitness", "PC Building"],
  currentFocus: "Building scalable web applications",
  lookingFor: "Software Development Opportunities",
  hobbies: ["Hockey", "Golf", "Football", "Hiking"],
};
```

- Currently working on full stack projects using modern frameworks
...
I'm actively seeking software development opportunities and always excited to collaborate on interesting projects!
